...
@pytest.mark.asyncio
async def test_suggest_warm_humid():
...
@pytest.mark.asyncio
async def test_suggest_steady_rain_warmth():
...
@pytest.mark.asyncio
async def test_pest_disease_zero_temp_c_not_falsy():
...
@pytest.mark.asyncio
async def test_pest_disease_zero_humidity_not_falsy():
...
@pytest.mark.asyncio
async def test_pest_disease_missing_current_returns_default():
    result = await pest_disease_service.suggest({})
