...
@pytest.mark.asyncio
async def test_suggest_heavy_rain():
...
@pytest.mark.asyncio
async def test_suggest_favorable_warm_dry():
...
@pytest.mark.asyncio
async def test_suggest_extreme_heat():
...
@pytest.mark.asyncio
async def test_harvest_reminder_zero_temp_c_not_falsy():
...
@pytest.mark.asyncio
async def test_harvest_reminder_zero_humidity_not_falsy():
...
@pytest.mark.asyncio
async def test_harvest_reminder_zero_precip_not_falsy():
...
@pytest.mark.asyncio
async def test_harvest_reminder_missing_current_defaults_to_zero():
    result = await harvest_reminder_service.suggest({})
